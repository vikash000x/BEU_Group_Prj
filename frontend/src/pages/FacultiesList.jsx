    ...
    >
      ...
      >
        ...
        <p 
          ...
          "
        >
          Explore the talented educators who drive academic excellence and innovation.
        </p>
      </motion.div>
              ...
              {filteredFaculties && filteredFaculties.length > 0 ? (
                filteredFaculties.map((faculty) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 hidden md:table-cell">{faculty.department}</td>
                    <td className="px-4 py-3 hidden lg:table-cell">{faculty.designation}</td>
                    {(userType === "college" && 
                      loggedInCollegeData.collegeCode === localStorage.getItem("collegeCode") &&
                      token) && (
