  ...
  const fetchAllNotices = async () => {
    try {
      ...
      const response = await axios.get(
        `${url}/notice/get-college-wise-notice/${collegeCode}`
      );
    ...
    <div className="min-h-screen bg-slate-900 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Recent Updates</h1>
          <p className="text-slate-400 max-w-2xl mx-auto">
            Stay informed with the latest updates, announcements, and events
            from colleges across the platform.
          </p>
        </div>
