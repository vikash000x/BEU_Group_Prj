...
const CollegeAdmin = () => {
  ...
  return (
    <div className="w-[1200px] flex flex-col items-center gap-12 mx-auto pt-10 min-h-auto bg-slate-700 py-4">
      <div className="w-1/2 rounded-md bg-gray-500 p-12 hover:scale-105 transition-all duration-200 cursor-pointer">
      ...
      <Link to={`/${collegeShortName}/postUpdate`}>
