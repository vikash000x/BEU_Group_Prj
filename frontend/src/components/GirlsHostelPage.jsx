...
const GirlsHostelPage = () => {
  ...
  const facilities = [
    ...
    },
    {
      ...
      items: [
        "24/7 Female Security Personnel",
        "CCTV Surveillance",
        "Biometric Entry System",
        "Lady Wardens Available 24/7",
    ...
    },
    {
      ...
      items: [
        ...
        "Dedicated Female Kitchen Staff",
  ...
  const rules = [
    ...
    "Prior permission required for outings"
  ];
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{displayName} - Girls Hostel</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            A secure and comfortable living space designed specifically for female students,
            providing a perfect blend of academic environment and modern amenities.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-600">400+ Students</p>
            </div>
            <div>
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Room Types</h3>
              <p className="text-gray-600">Single & Double Sharing</p>
            </div>
            <div>
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Wardens</h3>
              <p className="text-gray-600">4 Lady Wardens + Chief Warden</p>
            </div>
          </div>
        </div>
                ...
                <ul className="space-y-3">
                  {facility.items.map((item, i) => (
                    <li key={i} className="flex items-center text-gray-600">
                      <IoMdCheckmarkCircleOutline className="text-pink-500 mr-2 text-xl" />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        {/* Rules Section */}
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl shadow-lg p-8">
